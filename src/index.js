...
import 'grapesjs-plugin-file/dist/grapesjs-plugin-file.css';

import grapesjs from 'grapesjs';
import pluginBlocks from 'grapesjs-blocks-basic';
import pluginSave from 'grapesjs-plugin-call-save';
import pluginNavbar from 'grapesjs-navbar';
import pluginCountdown from 'grapesjs-component-countdown';
import pluginForms from 'grapesjs-plugin-forms';
import pluginExport from 'grapesjs-plugin-export';
import pluginFile from 'grapesjs-plugin-file';
...
export default grapesjs.plugins.add('gjs-preset-webpage', (editor, opts = {}) => {
  ...
  // Load plugins
  fileOpts && pluginFile(editor, fileOpts);
  ...
  callSaveOpts && pluginSave(editor, callSaveOpts);
