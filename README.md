# GrapesJS Preset Webpage Extend

## Summary

* Plugin name: **`gjs-preset-webpage-extend`**
* Includes:
  ...
  * `grapesjs-plugin-call-save` Call Save
* Commands:
...
| `callSaveOpts` | `grapesjs-plugin-call-save` plugin options. By setting this option to `false` will avoid loading the plugin | `{}` |
...
```sh
$ npm i grapesjs-preset-webpage-extend
```
...
```sh
$ git clone git@github.com:NortonPerson/grapesjs-preset-webpage-extend.git
```
